fun main() {
    val car1 = Car("Buggati, 2018", "Alex", 123, 100000.0, 99950.0)
    car1.getCarFullDetails()
    val car2 = Car("BMW, 2021", "Janak", 120, 400000.0, 499900.0)
    car2.getCarFullDetails()
    val Cars = ArrayList<Car> (2)
    val car3 = Car("Audi, 2018","Nishant",50,1080000.0,1078000.0)
    val car4 = Car("Maruti, 2019","parv",20,4000000.0,4998000.0)
    Cars.add(car3)
    Cars.add(car4)
    for (i in Cars){
        println("-------------------")
