fun main() {
    ...
    val firstMatrix = Matrix(arrayOf(intArrayOf(4,-1,6), intArrayOf(6,0,2)),2,3)
    val secondMatrix = Matrix(arrayOf(intArrayOf(2,8),intArrayOf(-8,0), intArrayOf(0,6)),3,2)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(5,4), intArrayOf(8,0), intArrayOf(3,4)),3,2)
    println("********** Addition **********")
    println("Matrix:1")
